...
const CheckoutPage: React.FC = () => {
  const { cart, cartTotal, checkoutUrl, syncCartWithCustomer } = useCart();
  ...
  const handleProceedToPayment = async () => {
    ...
    // Final sync with customer identity before redirecting
    if (isAuthenticated) {
      try {
        await syncCartWithCustomer();
      } catch (e) {
        console.warn("Pre-redirect sync failed", e);
      }
    }
