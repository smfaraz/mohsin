        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="lg:w-1/2">
            ...
            >
              ...
              <button 
                onClick={handleShare}
                className="absolute top-4 right-4 p-2 rounded-full bg-gray-100/80 hover:bg-gray-200 text-gray-600 transition-colors z-10 backdrop-blur-sm" 
                title="Share"
              >
                  <Share2 size={20} />
                  {isCopied && (
          ...
          <div className="lg:w-1/2">
            ...
            <div className="space-y-3 mb-6">
                <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div>
                        <p className="font-bold text-sm text-gray-800">{product.warranty || '1 Year'} Warranty</p>
                    ...
                    <div className="max-w-2xl">
                        <table className="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
                            <tbody className="divide-y divide-gray-100">
                                ...
                                <tr><td className="p-3 bg-gray-50 font-bold w-1/3">Warranty</td><td className="p-3">{product.warranty || '1 Year'}</td></tr>
